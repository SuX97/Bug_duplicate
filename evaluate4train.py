...
############## run evaluation ###############
evalResult = clsModel.evaluate(x=[clsTestA, clsTestB], y=clsTestLabel, batch_size=256)
print ("[Eval]:", clsModel.metrics_names[0], '-', evalResult[0], ' ', clsModel.metrics_names[1], '-', evalResult[1])
#############################################
####################################################
